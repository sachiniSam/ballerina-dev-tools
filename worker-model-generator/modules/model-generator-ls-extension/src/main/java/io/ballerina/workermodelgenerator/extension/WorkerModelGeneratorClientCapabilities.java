 ...
 * @since 2201.5.0
 */
public class WorkerModelGeneratorClientCapabilities extends BallerinaClientCapability {
    public WorkerModelGeneratorClientCapabilities() {
        super(WorkerModelGeneratorConstants.CAPABILITY_NAME);
    }
}
